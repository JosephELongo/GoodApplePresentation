...
#Because of the limited daily data, the first week of full data is January 12th, 2014 (I am assuming that the data represents the days from January 6th - January 12th)
...
#The commented out prints below show the coefficients of the regression, the MAE and MAPE of the regression, and the average value of Site Visitors
#print(reg.coef_)
predictions = reg.predict(dailyAndWeeklyData[["Channel 2 Views", "Term 2", "Channel 1 Views"]])
#print(mean_absolute_error(dailyAndWeeklyData["Site Visitors"], predictions))
#print(mean_absolute_percentage_error(dailyAndWeeklyData["Site Visitors"], predictions))
#print(y.mean())